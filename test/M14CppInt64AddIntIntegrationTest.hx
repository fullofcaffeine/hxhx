...
class M14CppInt64AddIntIntegrationTest {
	...
	static function main():Void {
		...
		final root = Path.join([Sys.getCwd(), ".tmp", "m14_cpp_int64_add_int"]);
		...
		assertTrue(generated.indexOf("Int64::addInt") < 0, "C++ emitted a nonexistent Int64.addInt helper");
		assertTrue(generated.indexOf("__hxhx_int64_add") >= 0, "C++ did not route Int64 addition through the wrapping carrier helper");
		assertTrue(generated.indexOf("static_cast<unsigned long long>") >= 0, "C++ Int64 addition does not make modulo arithmetic explicit");
