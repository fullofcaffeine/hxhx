...
class M14NativeMacroModuleHostAbiIntegrationTest {
	...
	static function main():Void {
		...
		assertFailsContains(function() NativeMacroModuleHostAbi.exprsForPlugin("v1\n", "fixture.native.macro.plugin", "fixture://empty"),
		...
		assertFailsContains(function()
			NativeMacroModuleHostAbi.exprsForPlugin("v1\nfixture.native.macro.plugin\tFixtureNativeMacroPlugin.smoke()\nfixture.native.macro.plugin\tFixtureNativeMacroPlugin.smoke()\n",
