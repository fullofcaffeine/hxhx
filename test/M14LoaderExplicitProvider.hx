...
class M14LoaderExplicitProvider implements ITargetBackendProvider {
	public function new() {}
	...
	public function registrations():Array<BackendRegistrationSpec> {
		final descriptor:backend.TargetDescriptor = {
			...
			priority: 10,
			description: "Explicit loader fixture",
			capabilities: {
				supportsNoEmit: true,
		...
		return [
			{
				...
				create: function() return new TargetCoreBackend(descriptor, function(_program, _context) throw "explicit fixture should not emit")
			}
		];
	}
}
