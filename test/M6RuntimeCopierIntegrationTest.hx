...
class M6RuntimeCopierIntegrationTest {
	...
	static function main() {
		...
		assertArrayEquals([
			...
			"haxe-array",
			"haxe-array-carrier",
			"haxe-array-index-read",
			"haxe-array-literal-construction",
			"haxe-bytes-access",
			"haxe-bytes-carrier",
			"haxe-bytes-producer",
			"haxe-bytes-read",
			"haxe-class-identity-marker",
			"haxe-dynamic-string",
			...
			"haxe-stack-traces",
			"haxe-standard-io",
			"haxe-static-string-conversion",
			"haxe-std-is-of-type",
			"haxe-string-equality",
			"haxe-string-field-read",
			"haxe-string-from-char-code",
			"haxe-string-method",
			"haxe-string-null-sentinel",
			"hxhx-runtime:function-return-signal-v1",
			"hxhx-runtime:function-void-return-signal-v1",
			"hxhx-runtime:loop-break-signal-v1",
			"hxhx-runtime:loop-continue-signal-v1",
			"hxhx-runtime:typed-haxe-catch-chain-v1",
			"hxhx-runtime:typed-haxe-exception-signal-v1"
		],
