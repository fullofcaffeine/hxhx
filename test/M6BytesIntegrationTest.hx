...
/** Checks generated Bytes operations, native behavior, and rejection of invalid representation reports. */
class M6BytesIntegrationTest {
	...
	**/
	static function refreshRepresentationRevision(report:Dynamic):Void {
		...
		Reflect.setField(report, "representationRevision", digest(representations));
	}
