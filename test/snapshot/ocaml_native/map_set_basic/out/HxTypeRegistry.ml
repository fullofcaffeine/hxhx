...
let init () : unit =
  ...
  HxType.register_class_instance_fields "ocaml._IntMap.IntMap_Impl_" [];
  HxType.register_class_static_fields "ocaml._IntMap.IntMap_Impl_" [ "_new"; "add"; "empty"; "find"; "findOpt"; "fold"; "isEmpty"; "iter"; "mem"; "remove" ];
  HxType.register_class_instance_fields "ocaml._IntSet.IntSet_Impl_" [];
  HxType.register_class_static_fields "ocaml._IntSet.IntSet_Impl_" [ "_new"; "add"; "empty"; "isEmpty"; "iter"; "mem"; "remove" ];
  HxType.register_class_instance_fields "ocaml._StringMap.StringMap_Impl_" [];
  HxType.register_class_static_fields "ocaml._StringMap.StringMap_Impl_" [ "_new"; "add"; "empty"; "find"; "findOpt"; "fold"; "isEmpty"; "iter"; "mem"; "remove" ];
  HxType.register_class_instance_fields "ocaml._StringSet.StringSet_Impl_" [];
  HxType.register_class_static_fields "ocaml._StringSet.StringSet_Impl_" [ "_new"; "add"; "empty"; "isEmpty"; "iter"; "mem"; "remove" ];
