...
let init () : unit =
  ...
  HxType.register_class_ctor "Box" (fun (args : Obj.t HxArray.t) ->
    let len = HxArray.length args in
    let a0 = if len > 0 then Obj.magic ((HxArray.get args 0)) else failwith "Type.createInstance: missing ctor arg 'a' for Box" in
    let a1 = if len > 1 then Obj.magic ((HxArray.get args 1)) else failwith "Type.createInstance: missing ctor arg 'h' for Box" in
    Obj.repr (Box.create a0 a1)
  );
  ...
  HxType.register_class_empty_ctor "Box" (fun () -> Obj.repr (Box.__empty ()));
  ...
  HxType.register_class_instance_fields "Box" [ "a"; "h" ];
  HxType.register_class_static_fields "Box" [];
  ...
  HxType.register_class_instance_fields "ocaml._Array.Array_Impl_" [];
  HxType.register_class_static_fields "ocaml._Array.Array_Impl_" [ "_new"; "fold_left"; "get"; "init"; "iter"; "length"; "make"; "map"; "set" ];
  ...
  HxType.register_class_instance_fields "ocaml._Bytes.Bytes_Impl_" [];
  HxType.register_class_static_fields "ocaml._Bytes.Bytes_Impl_" [ "_new"; "length"; "make"; "ofString"; "sub"; "toString" ];
  HxType.register_class_instance_fields "ocaml._Char.Char_Impl_" [];
  HxType.register_class_static_fields "ocaml._Char.Char_Impl_" [ "_new"; "ofInt" ];
  HxType.register_class_instance_fields "ocaml._Hashtbl.Hashtbl_Impl_" [];
  HxType.register_class_static_fields "ocaml._Hashtbl.Hashtbl_Impl_" [ "_new"; "add"; "create"; "find"; "findOpt"; "length"; "mem"; "remove"; "replace" ];
  HxType.register_class_instance_fields "ocaml._Seq.Seq_Impl_" [];
  HxType.register_class_static_fields "ocaml._Seq.Seq_Impl_" [ "_new"; "append"; "cons"; "empty"; "filter"; "foldLeft"; "iter"; "map"; "return_" ];
