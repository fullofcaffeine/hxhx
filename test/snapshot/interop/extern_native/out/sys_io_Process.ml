...
type ocamlprocessinput_t = { __hx_type : Obj.t; mutable bigEndian : bool; set_bigEndian : Obj.t -> bool -> bool; readByte : Obj.t -> unit -> int; readBytes : Obj.t -> HxBytes.t -> int -> int -> int; close : Obj.t -> unit -> unit; readAll : Obj.t -> Obj.t -> HxBytes.t; readFullBytes : Obj.t -> HxBytes.t -> int -> int -> unit; readLine : Obj.t -> unit -> string; mutable handle : int; mutable stream : int }
...
let ocamlprocessinput_readBytes__impl = fun (self : ocamlprocessinput_t) buf pos len -> try (
...
type ocamlprocessoutput_t = { __hx_type : Obj.t; mutable bigEndian : bool; set_bigEndian : Obj.t -> bool -> bool; writeByte : Obj.t -> int -> unit; writeBytes : Obj.t -> HxBytes.t -> int -> int -> int; flush : Obj.t -> unit -> unit; close : Obj.t -> unit -> unit; write : Obj.t -> HxBytes.t -> unit; writeFullBytes : Obj.t -> HxBytes.t -> int -> int -> unit; prepare : Obj.t -> int -> unit; writeInput : Obj.t -> Haxe_io_Input.t -> Obj.t -> unit; writeString : Obj.t -> string -> Obj.t -> unit; writeInt8 : Obj.t -> int -> unit; writeUInt8 : Obj.t -> int -> unit; writeInt16 : Obj.t -> int -> unit; writeUInt16 : Obj.t -> int -> unit; writeInt24 : Obj.t -> int -> unit; writeUInt24 : Obj.t -> int -> unit; writeInt32 : Obj.t -> int -> unit; mutable handle : int }

let ocamlprocessoutput___ctor = fun (self : ocamlprocessoutput_t) handle2 -> ignore ((
  ignore (Haxe_io_Output.__ctor (Obj.magic self) ());
  let __assign_1 = handle2 in (
    self.handle <- __assign_1;
    __assign_1
  )
))

let ocamlprocessoutput_writeByte__impl = fun (self : ocamlprocessoutput_t) c -> ignore (HxProcess.write_byte (self.handle) c)

let ocamlprocessoutput_writeBytes__impl = fun (self : ocamlprocessoutput_t) buf pos len -> try (
  ignore (if len <= 0 then raise (HxRuntime.Hx_return (Obj.repr 0)) else ());
...
let ocamlprocessoutput_writeString__impl = fun (self : ocamlprocessoutput_t) s encoding -> ignore (try (
