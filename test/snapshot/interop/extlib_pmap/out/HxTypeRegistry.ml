...
let init () : unit =
  ...
  HxType.register_class_instance_fields "ocaml.extlib._PMap.PMap_Impl_" [];
  HxType.register_class_static_fields "ocaml.extlib._PMap.PMap_Impl_" [ "_new"; "add"; "create"; "empty"; "exists"; "find"; "fold"; "foldi"; "is_empty"; "iter"; "map"; "mapi"; "mem"; "remove" ];
