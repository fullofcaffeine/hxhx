...
class M14CppInt64ModIntIntegrationTest {
	...
	static function main():Void {
		final sourcePath = "test/oracle/cpp_int64_mod_int_seed/src/Main.hx";
		...
		final int64Source = [
			...
			"  public static function mod(left:Int64, right:Int64):Int64 return left;",
			"  @:op(A % B) private static inline function modInt(value:Int64, divisor:Int):Int64 return value;",
			"}",
		].join("\n");
		...
		final root = Path.join([Sys.getCwd(), ".tmp", "m14_cpp_int64_mod_int"]);
		...
		assertTrue(generated.indexOf("Int64::modInt") < 0, "C++ emitted a nonexistent Int64.modInt helper");
		assertTrue(generated.indexOf("Int64::mod(") < 0, "C++ emitted Int64.mod instead of the native carrier helper");
		assertTrue(generated.split("__hxhx_int64_mod(").length > 5, "C++ did not route Int64 remainder through the checked carrier helper");
		...
		final expected = File.getContent("test/oracle/cpp_int64_mod_int_seed/expected.stdout");
