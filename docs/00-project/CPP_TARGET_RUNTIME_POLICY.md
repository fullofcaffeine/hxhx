...
- The first `haxe_ocaml-puquq` implementation seam is typed enum carrier
  ...
  constructors. This is intentionally smaller than parity. Non-string payload
  identity, broad erased `EnumValue`/Dynamic behavior, and
