...
Measured on July 3, 2026. The guard allows small drift but asks for this table
...
| `packages/hxhx-core/src/backend/cpp/CppTargetCore.hx` | 19,523 | Cpp rendering, helper reachability, runtime support coordination, type-flow inference, and smoke support can accumulate in one emitter. |
