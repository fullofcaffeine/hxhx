...
Measured on July 7, 2026. The guard allows small drift but asks for this table
...
| `packages/hxhx-core/src/backend/cpp/CppTargetCore.hx` | 21,210 | Cpp rendering, helper reachability, runtime support coordination, type-flow inference, and smoke support can accumulate in one emitter. |
