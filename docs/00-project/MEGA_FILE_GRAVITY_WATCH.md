...
| `packages/hxhx-core/src/backend/cpp/CppTargetCore.hx` | 23,551 | Cpp rendering, helper reachability, runtime support coordination, type-flow inference, and smoke support can accumulate in one emitter. |
