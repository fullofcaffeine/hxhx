...
| `packages/hxhx-core/src/backend/cpp/CppTargetCore.hx` | 25,801 | Cpp rendering, helper reachability, runtime support coordination, type-flow inference, and smoke support can accumulate in one emitter. |
