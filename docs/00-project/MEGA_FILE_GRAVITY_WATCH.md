...
Measured on July 10, 2026. The guard allows small drift but asks for this table
...
| `packages/hxhx-core/src/backend/cpp/CppTargetCore.hx` | 25,875 | Cpp rendering, helper reachability, runtime support coordination, type-flow inference, and smoke support can accumulate in one emitter. |
