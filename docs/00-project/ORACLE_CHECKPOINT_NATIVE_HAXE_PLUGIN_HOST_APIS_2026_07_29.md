...
Any distribution that derives declarations from private copyleft-licensed compiler
interfaces, links or bundles copyleft-licensed compiler units, or claims an MIT-only combined
...
evidence. Do not copy, translate, retype, or mechanically rewrite copyleft-licensed compiler
