...
let rec collectClosureVectorEvidenceFromExpr = fun self (expr : HxExpr.hxexpr) (scope : Obj.t) (candidates : bool HxMap.string_map) (pushedValues : HxExpr.hxexpr HxArray.t HxMap.string_map) (callArgTypes : string HxArray.t HxArray.t HxMap.string_map) -> ignore (ignore (let _gthis = Obj.magic self in match expr with
  ...
  | HxExpr.ECall (_p0, _p1) -> ignore (let _g = Obj.magic _p0 in let _g1 = Obj.magic _p1 in match _g with
    | HxExpr.EField (_p0, _p1) -> ignore (let _g2 = Obj.magic _p0 in let _g3 = (_p1 : string) in if (match _g2 with
      ...
      ignore (if not (HxMap.exists_string pushedValues local) then ignore (HxMap.set_string pushedValues local (let __arr_78 = HxArray.create () in __arr_78)) else ());
      ...
      let _g6 = ref 0 in while !_g6 < HxArray.length args do ignore (let arg = Obj.magic (HxArray.get (Obj.magic args) (!_g6)) in (
        ignore (let __old_79 = !_g6 in let __new_80 = HxInt.add __old_79 1 in (
          ignore (_g6 := __new_80);
          __new_80
        ));
      ...
      ignore (collectClosureVectorEvidenceFromExpr (Obj.magic self) (Obj.magic callee) scope (Obj.magic candidates) (Obj.magic pushedValues) (Obj.magic callArgTypes));
      let _g4 = ref 0 in while !_g4 < HxArray.length args do ignore (let arg = Obj.magic (HxArray.get (Obj.magic args) (!_g4)) in (
        ignore (let __old_85 = !_g4 in let __new_86 = HxInt.add __old_85 1 in (
          ignore (_g4 := __new_86);
          __new_86
        ));
        collectClosureVectorEvidenceFromExpr (Obj.magic self) (Obj.magic arg) scope (Obj.magic candidates) (Obj.magic pushedValues) (Obj.magic callArgTypes)
    ...
    | HxExpr.EArrayAccess (_p0, _p1) -> ignore (let _g2 = Obj.magic _p0 in let _g3 = Obj.magic _p1 in if (match _g2 with
      ...
      ignore (if not (HxMap.exists_string callArgTypes local) then ignore (HxMap.set_string callArgTypes local (let __arr_88 = HxArray.create () in __arr_88)) else ());
      let _g5 = Obj.magic (let __arr_89 = HxArray.create () in __arr_89) in let _g6 = ref 0 in (
        ignore (while !_g6 < HxArray.length args do ignore (let arg = Obj.magic (HxArray.get (Obj.magic args) (!_g6)) in (
          ignore (let __old_90 = !_g6 in let __new_91 = HxInt.add __old_90 1 in (
            ignore (_g6 := __new_91);
            __new_91
          ));
      ...
      ignore (collectClosureVectorEvidenceFromExpr (Obj.magic self) (Obj.magic callee) scope (Obj.magic candidates) (Obj.magic pushedValues) (Obj.magic callArgTypes));
      let _g4 = ref 0 in while !_g4 < HxArray.length args do ignore (let arg = Obj.magic (HxArray.get (Obj.magic args) (!_g4)) in (
        ignore (let __old_96 = !_g4 in let __new_97 = HxInt.add __old_96 1 in (
          ignore (_g4 := __new_97);
          __new_97
        ));
        collectClosureVectorEvidenceFromExpr (Obj.magic self) (Obj.magic arg) scope (Obj.magic candidates) (Obj.magic pushedValues) (Obj.magic callArgTypes)
...
let closureVectorCallArgTypes = fun self (callShapes : string HxArray.t HxArray.t) (arity : int) -> (
  ignore self;
  try let __fallback_result_183 = (
    ignore (if arity = 0 then raise (HxRuntime.Hx_return (Obj.repr (Obj.magic (let __arr_174 = HxArray.create () in __arr_174)))) else ());
    ignore (if callShapes == Obj.magic (HxRuntime.hx_null) then raise (HxRuntime.Hx_return (Obj.repr (Obj.magic (let __arr_175 = HxArray.create () in __arr_175)))) else ());
    let _g = ref 0 in (
      ignore (try while !_g < HxArray.length callShapes do try ignore (let shape = Obj.magic (HxArray.get (Obj.magic callShapes) (!_g)) in (
        ...
        let complete = ref true in let _g2 = ref 0 in (
          ignore (while !_g2 < HxArray.length shape do ignore (let typeName = (HxArray.get (Obj.magic shape) (!_g2) : string) in (
            ...
            if typeName == HxString.hx_null_string || HxString.length typeName = 0 then ignore (let __assign_180 = false in (
              complete := __assign_180;
              __assign_180
            )) else ()
          )) done);
        ...
        | HxRuntime.Hx_break -> ());
      let __arr_181 = HxArray.create () in __arr_181
    )
...
let closureVectorPushedValueType = fun self (value : HxExpr.hxexpr) (callShapes : string HxArray.t HxArray.t) (scope : Obj.t) -> let tempResult = ref (HxString.hx_null_string : string) in (
  ignore (match value with
    | HxExpr.ECall (_p0, _p1) -> let _g = Obj.magic _p0 in let _g1 = Obj.magic _p1 in if (match _g with
      ...
      | HxExpr.ELambda (__enum_param_139, _) -> __enum_param_139
      | _ -> failwith "Unexpected enum parameter") in let _g6 = Obj.magic (match _g3 with
      | HxExpr.ELambda (_, __enum_param_140) -> __enum_param_140
      ...
      ignore (match _g4 with
        | HxExpr.EArrayDecl __enum_param_141 -> __enum_param_141
        | _ -> failwith "Unexpected enum parameter");
      let body = Obj.magic _g6 in let args = Obj.magic _g5 in let argTypes = Obj.magic (closureVectorCallArgTypes (Obj.magic self) (Obj.magic callShapes) (HxArray.length args)) in let __assign_142 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "inferredLambdaCppFunctionType") (Obj.magic args) (Obj.magic body) (Obj.magic argTypes) scope : string) in (
        tempResult := __assign_142;
        __assign_142
      )
    ) else let __assign_143 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "dynamicLocalAssignedType") (Obj.magic value) scope : string) in (
    ...
    | HxExpr.ELambda (_p0, _p1) -> let _g = Obj.magic _p0 in let _g1 = Obj.magic _p1 in let args = Obj.magic _g in let body = Obj.magic _g1 in let argTypes = Obj.magic (closureVectorCallArgTypes (Obj.magic self) (Obj.magic callShapes) (HxArray.length args)) in let __assign_148 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "inferredLambdaCppFunctionType") (Obj.magic args) (Obj.magic body) (Obj.magic argTypes) scope : string) in (
      tempResult := __assign_148;
      __assign_148
    )
    | HxExpr.EAnon (_p0, _p1) -> let _g = Obj.magic _p0 in let _g1 = Obj.magic _p1 in let fieldNames = Obj.magic _g in let fieldValues = Obj.magic _g1 in let __assign_149 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "anonStructName") (Obj.magic fieldNames) (Obj.magic fieldValues) scope : string) in (
      tempResult := __assign_149;
      __assign_149
    )
    | _ -> let __assign_137 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "dynamicLocalAssignedType") (Obj.magic value) scope : string) in (
...
let rec collectClosureVectorPushedTypesFromExpr = fun self (expr : HxExpr.hxexpr) (scope : Obj.t) (candidates : bool HxMap.string_map) (callArgTypes : string HxArray.t HxArray.t HxMap.string_map) (pushedTypes : string HxArray.t HxMap.string_map) -> ignore (ignore (let _gthis = Obj.magic self in match expr with
  ...
  | HxExpr.ECall (_p0, _p1) -> ignore (let _g = Obj.magic _p0 in let _g1 = Obj.magic _p1 in if (match _g with
    ...
    | _ -> failwith "Unexpected enum parameter" : string) in if HxString.equals _g3 "push" then ignore (if HxArray.length _g1 = 1 then ignore (let _g5 = Obj.magic (HxArray.get (Obj.magic _g1) 0) in let value = Obj.magic _g5 in let name = (_g4 : string) in if HxMap.exists_string candidates (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "sanitizeIdentifier") (name : string)) then ignore (let local = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "sanitizeIdentifier") (name : string) : string) in (
    ignore (if not (HxMap.exists_string pushedTypes local) then ignore (HxMap.set_string pushedTypes local (let __arr_115 = HxArray.create () in __arr_115)) else ());
    let tempArray = ref (Obj.magic (HxRuntime.hx_null) : string HxArray.t HxArray.t) in (
      ignore (if HxMap.exists_string callArgTypes local then let __assign_116 = Obj.magic (HxMap.get_string callArgTypes local) in (
        tempArray := __assign_116;
        __assign_116
      ) else let __assign_117 = Obj.magic (let __arr_118 = HxArray.create () in __arr_118) in (
    ...
    let _g6 = ref 0 in while !_g6 < HxArray.length args do ignore (let arg = Obj.magic (HxArray.get (Obj.magic args) (!_g6)) in (
      ignore (let __old_119 = !_g6 in let __new_120 = HxInt.add __old_119 1 in (
        ignore (_g6 := __new_120);
        __new_120
      ));
...
let closureVectorElementType = fun self (values : HxExpr.hxexpr HxArray.t) (callShapes : string HxArray.t HxArray.t) (scope : Obj.t) -> try let __fallback_result_173 = (
      ...
      let tempString = ref (HxString.hx_null_string : string) in (
        ignore (match value with
          | HxExpr.ECall (_p0, _p1) -> let _g2 = Obj.magic _p0 in let _g1 = Obj.magic _p1 in if (match _g2 with
            ...
            | HxExpr.ELambda (__enum_param_161, _) -> __enum_param_161
            | _ -> failwith "Unexpected enum parameter") in let _g7 = Obj.magic (match _g4 with
            | HxExpr.ELambda (_, __enum_param_162) -> __enum_param_162
          ...
          | HxExpr.ELambda (_p0, _p1) -> let _g2 = Obj.magic _p0 in let _g1 = Obj.magic _p1 in let args = Obj.magic _g2 in let body = Obj.magic _g1 in let argTypes = Obj.magic (closureVectorCallArgTypes (Obj.magic self) (Obj.magic callShapes) (HxArray.length args)) in let __assign_170 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "inferredLambdaCppFunctionType") (Obj.magic args) (Obj.magic body) (Obj.magic argTypes) scope : string) in (
            tempString := __assign_170;
            __assign_170
          )
          | HxExpr.EAnon (_p0, _p1) -> let _g2 = Obj.magic _p0 in let _g1 = Obj.magic _p1 in let fieldNames = Obj.magic _g2 in let fieldValues = Obj.magic _g1 in let __assign_171 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "anonStructName") (Obj.magic fieldNames) (Obj.magic fieldValues) scope : string) in (
            tempString := __assign_171;
            __assign_171
          )
          | _ -> let __assign_159 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "dynamicLocalAssignedType") (Obj.magic value) scope : string) in (
...
let closureVectorTypeForLambdaArgImpl = fun self (local : string) (body : HxExpr.hxexpr) (scope : Obj.t) -> try let __fallback_result_156 = let candidates = Obj.magic (HxMap.create_string ()) in (
  ...
  let pushedValues = Obj.magic (HxMap.create_string ()) in let callArgTypes = Obj.magic (HxMap.create_string ()) in (
    ...
    let tempArray = ref (Obj.magic (HxRuntime.hx_null) : string HxArray.t HxArray.t) in (
      ignore (if HxMap.exists_string callArgTypes local then let __assign_150 = Obj.magic (HxMap.get_string callArgTypes local) in (
        tempArray := __assign_150;
        __assign_150
      ) else let __assign_151 = Obj.magic (let __arr_152 = HxArray.create () in __arr_152) in (
        tempArray := __assign_151;
        __assign_151
      ));
      let elementType = (closureVectorElementType (Obj.magic self) (Obj.magic (HxMap.get_string pushedValues local)) (Obj.magic (!tempArray)) scope : string) in let tempResult = ref (HxString.hx_null_string : string) in (
        ignore (if HxString.length elementType = 0 then let __assign_153 = "" in (
          tempResult := __assign_153;
          __assign_153
        ) else let __assign_154 = ("std::vector<" ^ HxString.toStdString elementType) ^ ">" in (
...
let isEmptyArrayExpr = fun self (init : Obj.t) -> (
  ...
  let tempResult = ref (false : bool) in (
    ignore (if init == Obj.magic (HxRuntime.hx_null) then let __assign_193 = false in (
      ...
      | 18 -> let _g = (let __enum_param_196 = init in if __enum_param_196 == HxRuntime.hx_null then failwith "Unexpected enum parameter" else match Obj.obj __enum_param_196 with
        | HxExpr.ENew (__enum_param_195, _) -> __enum_param_195
        | _ -> failwith "Unexpected enum parameter" : string) in let _g1 = Obj.magic (let __enum_param_198 = init in if __enum_param_198 == HxRuntime.hx_null then failwith "Unexpected enum parameter" else match Obj.obj __enum_param_198 with
        | HxExpr.ENew (_, __enum_param_197) -> __enum_param_197
        | _ -> failwith "Unexpected enum parameter") in let typePath = (_g : string) in let args = Obj.magic _g1 in let __assign_199 = HxArray.length args = 0 && (let __call_arg_0_200 = typePath in Backend_cpp_CppTypeModel.isStdArrayTypePath __call_arg_0_200) in (
...
let isUnhintedEmptyArray = fun self (typeHint : string) (init : Obj.t) -> try let __fallback_result_192 = let tempString = ref (HxString.hx_null_string : string) in (
  ...
  ignore (if HxString.length (let __call_arg_0_190 = !tempString in StringTools.trim __call_arg_0_190) > 0 then raise (HxRuntime.Hx_return (Obj.repr false)) else ());
...
let rec collectClosureVectorLocalCandidatesFromStmt = fun self (stmt : HxStmt.hxstmt) (candidates : bool HxMap.string_map) -> ignore (ignore (match stmt with
  ...
  | HxStmt.SExpr (_p0, _p1) -> ignore (let _g = Obj.magic _p0 in (
    ...
    if (match _g with
      ...
      | HxExpr.EBinop (__enum_param_65, _, _) -> __enum_param_65
      ...
      | HxExpr.EIdent __enum_param_68 -> __enum_param_68
...
let inferClosureVectorLocalTypeOverridesImpl = fun self (scope : Obj.t) (stmts : HxStmt.hxstmt HxArray.t) -> ignore (ignore (try ignore (let _gthis = Obj.magic self in let candidates = Obj.magic (HxMap.create_string ()) in let _g = ref 0 in (
  ...
  let map = Obj.magic (Obj.obj (HxAnon.get scope "localTypes")) in let tempStringMap = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic map)) in let savedLocalTypes = Obj.magic tempStringMap in let map = Obj.magic (Obj.obj (HxAnon.get scope "localNames")) in let tempStringMap1 = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic map)) in let savedLocalNames = Obj.magic tempStringMap1 in let map = Obj.magic (Obj.obj (HxAnon.get scope "localNameCounts")) in let tempStringMap2 = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyIntMap") (Obj.magic map)) in let savedLocalNameCounts = Obj.magic tempStringMap2 in let map = Obj.magic (Obj.obj (HxAnon.get scope "localTypeOverrides")) in let tempStringMap3 = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic map)) in let savedLocalTypeOverrides = Obj.magic tempStringMap3 in let restoreScope = fun () -> ignore ((
...
let restoreStringMap = fun self (target : string HxMap.string_map) (saved : string HxMap.string_map) -> ignore ((
  ignore self;
  ignore (let _g = Obj.magic (let __arr_250 = HxArray.create () in __arr_250) in let key = HxIterator.of_array (HxMap.keys_string target) in (
    ignore (while (let __iter_251 = key in fun () -> HxIterator.hasNext (Obj.magic __iter_251)) () do ignore (let key2 = ((let __iter_252 = key in fun () -> HxIterator.next (Obj.magic __iter_252)) () : string) in if not (HxMap.exists_string saved key2) then ignore (HxArray.push _g key2) else ()) done);
    let tempArray = Obj.magic _g in let stale = Obj.magic tempArray in let _g = ref 0 in (
      ...
      let key = HxIterator.of_array (HxMap.keys_string saved) in while (let __iter_255 = key in fun () -> HxIterator.hasNext (Obj.magic __iter_255)) () do ignore (let key2 = ((let __iter_256 = key in fun () -> HxIterator.next (Obj.magic __iter_256)) () : string) in HxMap.set_string target key2 (HxMap.get_string saved key2)) done
    )
  ))
))

let withStringMapInferenceScope = fun self (scope : Obj.t) (candidates : string HxMap.string_map) (fn : unit -> unit) -> ignore (ignore (let map = Obj.magic (Obj.obj (HxAnon.get scope "localTypes")) in let tempStringMap = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic map)) in let savedLocalTypes = Obj.magic tempStringMap in let map = Obj.magic (Obj.obj (HxAnon.get scope "localTypeOverrides")) in let tempStringMap1 = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic map)) in let savedLocalTypeOverrides = Obj.magic tempStringMap1 in let map = Obj.magic (Obj.obj (HxAnon.get scope "localNames")) in let tempStringMap2 = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic map)) in let savedLocalNames = Obj.magic tempStringMap2 in let map = Obj.magic (Obj.obj (HxAnon.get scope "localNameCounts")) in let tempStringMap3 = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyIntMap") (Obj.magic map)) in let savedLocalNameCounts = Obj.magic tempStringMap3 in let savedCandidates = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic candidates)) in (
  ignore (let __call_callee_245 = fn in __call_callee_245 ());
  ignore (let __assign_246 = Obj.magic savedLocalTypes in (
    HxAnon.set scope "localTypes" (Obj.repr __assign_246);
    __assign_246
  ));
  ignore (let __assign_247 = Obj.magic savedLocalTypeOverrides in (
    HxAnon.set scope "localTypeOverrides" (Obj.repr __assign_247);
    __assign_247
  ));
  ignore (let __assign_248 = Obj.magic savedLocalNames in (
    HxAnon.set scope "localNames" (Obj.repr __assign_248);
    __assign_248
  ));
  ignore (let __assign_249 = Obj.magic savedLocalNameCounts in (
    HxAnon.set scope "localNameCounts" (Obj.repr __assign_249);
    __assign_249
  ));
...
let mapClassNameFromNewExpr = fun self (expr : Obj.t) -> let tempResult = ref (HxString.hx_null_string : string) in (
  ignore (if expr == Obj.magic (HxRuntime.hx_null) then let __assign_257 = ("" : string) in (
    tempResult := __assign_257;
    __assign_257
  ) else if (let __enum_idx_258 = expr in if __enum_idx_258 == HxRuntime.hx_null then -1 else match Obj.obj __enum_idx_258 with
    | HxExpr.ENull -> 0
    | HxExpr.EBool _ -> 1
    | HxExpr.EString _ -> 2
    | HxExpr.EInt _ -> 3
    ...
    | HxExpr.EWhile (_, _, _, _) -> 33
    | HxExpr.EBreak _ -> 34
    | HxExpr.EContinue _ -> 35) = 18 then let _g = (let __enum_param_260 = expr in if __enum_param_260 == HxRuntime.hx_null then failwith "Unexpected enum parameter" else match Obj.obj __enum_param_260 with
    | HxExpr.ENew (__enum_param_259, _) -> __enum_param_259
    | _ -> failwith "Unexpected enum parameter" : string) in (
    ignore (let __enum_param_262 = expr in if __enum_param_262 == HxRuntime.hx_null then failwith "Unexpected enum parameter" else match Obj.obj __enum_param_262 with
      | HxExpr.ENew (_, __enum_param_261) -> __enum_param_261
      | _ -> failwith "Unexpected enum parameter");
    let typePath = (_g : string) in let path = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "typeBaseName") (typePath : string) : string) in let tempString = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "sanitizeTypePath") (path : string) : string) in let className = (tempString : string) in if Obj.obj (HxAnon.get ((Obj.magic self : t).api) "isInferredMapClassName") (className : string) then let __assign_263 = (className : string) in (
...
let defaultMapLocalType = fun self (mapClass : string) -> let path = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "typeBaseName") (mapClass : string) : string) in let tempString = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "sanitizeTypePath") (path : string) : string) in let tempResult = ref (HxString.hx_null_string : string) in (
  ignore (if HxString.equals tempString "Map" then let __assign_266 = "std::shared_ptr<Map<std::string, std::string>>" in (
    tempResult := __assign_266;
    __assign_266
  ) else let __assign_267 = ("std::shared_ptr<" ^ HxString.toStdString tempString) ^ "<std::string>>" in (
...
let mapKeyTypeFromExpr = fun self (expr : HxExpr.hxexpr) (scope : Obj.t) -> try let __fallback_result_271 = let explicit = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "exprCppType") (Obj.magic expr) scope : string) in (
  ...
  let inferred = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "inferExprCppType") (Obj.magic expr) scope : string) in (
    ...
    let tempResult = ref (HxString.hx_null_string : string) in (
      ignore (if Obj.obj (HxAnon.get ((Obj.magic self : t).api) "isStringLike") (Obj.magic expr) then let __assign_268 = "std::string" in (
        tempResult := __assign_268;
        __assign_268
      ) else let __assign_269 = "int" in (
...
let stringMapValueTypeFromExpr = fun self (expr : HxExpr.hxexpr) (scope : Obj.t) -> try let __fallback_result_275 = let explicit = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "exprCppType") (Obj.magic expr) scope : string) in (
  ignore (if HxString.length explicit > 0 then raise (HxRuntime.Hx_return (Obj.repr (explicit : string))) else ());
  let inferred = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "inferExprCppType") (Obj.magic expr) scope : string) in let tempResult = ref (HxString.hx_null_string : string) in (
    ignore (if HxString.length inferred > 0 then let __assign_272 = (inferred : string) in (
...
let mapLocalType = fun self (mapClass : string) (keyType : string) (valueType : string) -> let tempString1 = ref (HxString.hx_null_string : string) in (
  ignore (if mapClass == HxString.hx_null_string then let __assign_279 = ("" : string) in (
    tempString1 := __assign_279;
    __assign_279
  ) else let __assign_280 = (mapClass : string) in (
  ...
  let path = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "typeBaseName") (!tempString1 : string) : string) in let tempString = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "sanitizeTypePath") (path : string) : string) in let tempResult = ref (HxString.hx_null_string : string) in (
    ignore (if HxString.equals tempString "Map" then let tempString2 = ref (HxString.hx_null_string : string) in (
      ignore (if keyType == HxString.hx_null_string || HxString.length keyType = 0 then let __assign_281 = ("std::string" : string) in (
        tempString2 := __assign_281;
        __assign_281
      ) else let __assign_282 = (keyType : string) in (
        tempString2 := __assign_282;
        __assign_282
      ));
      let __assign_283 = ((("std::shared_ptr<Map<" ^ HxString.toStdString (!tempString2)) ^ ", ") ^ HxString.toStdString valueType) ^ ">>" in (
        tempResult := __assign_283;
        __assign_283
      )
    ) else let __assign_284 = ((("std::shared_ptr<" ^ HxString.toStdString tempString) ^ "<") ^ HxString.toStdString valueType) ^ ">>" in (
...
let mapClassNameFromCppMapType = fun self (typeName : string) -> try let __fallback_result_294 = (
  ...
  let prefix = "std::shared_ptr<" in (
    ignore (if not (let __call_arg_0_285 = typeName in let __call_arg_1_286 = prefix in StringTools.startsWith __call_arg_0_285 __call_arg_1_286) || not (let __call_arg_0_287 = typeName in let __call_arg_1_288 = ">" in StringTools.endsWith __call_arg_0_287 __call_arg_1_288) then raise (HxRuntime.Hx_return (Obj.repr ("" : string))) else ());
    let inner = (HxString.substr typeName (HxString.length prefix) (HxInt.sub (HxInt.sub (HxString.length typeName) (HxString.length prefix)) 1) : string) in let genericStart = HxString.indexOf inner "<" 0 in let tempString = ref (HxString.hx_null_string : string) in (
      ignore (if genericStart >= 0 then let __assign_289 = (HxString.substr inner 0 genericStart : string) in (
        tempString := __assign_289;
        __assign_289
      ) else let __assign_290 = (inner : string) in (
        tempString := __assign_290;
        __assign_290
      ));
      let className = (!tempString : string) in let tempResult = ref (HxString.hx_null_string : string) in (
        ignore (if Obj.obj (HxAnon.get ((Obj.magic self : t).api) "isInferredMapClassName") (className : string) then let path = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "typeBaseName") (className : string) : string) in let __assign_291 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "sanitizeTypePath") (path : string) : string) in (
...
let setStringMapLocalTypeOverride = fun self (scope : Obj.t) (local : string) (mapClass : string) (keyType : string) (valueType : string) -> ignore (ignore (try ignore (let tempString1 = ref (HxString.hx_null_string : string) in (
  ignore (if mapClass == HxString.hx_null_string then let __assign_276 = ("" : string) in (
    tempString1 := __assign_276;
    __assign_276
  ) else let __assign_277 = (mapClass : string) in (
  ...
  match expr with
    ...
    | HxExpr.ECall (_p0, _p1) -> ignore (let _g = Obj.magic _p0 in let _g1 = Obj.magic _p1 in if (match _g with
      ...
      let _g7 = ref 0 in while !_g7 < HxArray.length args do ignore (let arg = Obj.magic (HxArray.get (Obj.magic args) (!_g7)) in (
        ignore (let __old_228 = !_g7 in let __new_229 = HxInt.add __old_228 1 in (
          ignore (_g7 := __new_229);
          __new_229
        ));
      ...
      ignore (collectStringMapLocalTypeOverridesFromExpr (Obj.magic self) (Obj.magic callee) scope (Obj.magic candidates));
      let _g5 = ref 0 in while !_g5 < HxArray.length args do ignore (let arg = Obj.magic (HxArray.get (Obj.magic args) (!_g5)) in (
        ignore (let __old_232 = !_g5 in let __new_233 = HxInt.add __old_232 1 in (
          ignore (_g5 := __new_233);
          __new_233
        ));
        collectStringMapLocalTypeOverridesFromExpr (Obj.magic self) (Obj.magic arg) scope (Obj.magic candidates)
      )) done
  ...
  | HxStmt.SVar (_p0, _p1, _p2, _p3, _p4) -> ignore (let _g = (_p0 : string) in let _g1 = (_p1 : string) in let _g2 = Obj.obj (HxEnum.unbox_or_obj "HxExpr" _p2) in (
    ...
    let name = (_g : string) in let typeHint = (_g1 : string) in let init = Obj.obj (HxEnum.unbox_or_obj "HxExpr" _g2) in (
      ...
      let local = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "declareLocalName") (name : string) scope : string) in let mapClass = (mapClassNameFromNewExpr (Obj.magic self) (Obj.obj (HxEnum.unbox_or_obj "HxExpr" init)) : string) in let tempString = ref (HxString.hx_null_string : string) in (
        ignore (if typeHint == HxString.hx_null_string then let __assign_216 = ("" : string) in (
        ...
        let unhinted = HxString.length (let __call_arg_0_218 = !tempString in StringTools.trim __call_arg_0_218) = 0 in let tempString1 = ref (HxString.hx_null_string : string) in (
          ignore (if init == Obj.magic (HxRuntime.hx_null) then let __assign_219 = ("" : string) in (
            tempString1 := __assign_219;
            __assign_219
          ) else let __assign_220 = (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "arrowMapLiteralCppType") (Obj.obj (HxEnum.unbox_or_obj "HxExpr" init)) scope : string) in (
...
let inferStringMapLocalTypeOverridesFromStmtsImpl = fun self (scope : Obj.t) (stmts : HxStmt.hxstmt HxArray.t) -> ignore (ignore (let map = Obj.magic (Obj.obj (HxAnon.get scope "localTypes")) in let tempStringMap = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic map)) in let savedLocalTypes = Obj.magic tempStringMap in let map = Obj.magic (Obj.obj (HxAnon.get scope "localNames")) in let tempStringMap1 = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyStringMap") (Obj.magic map)) in let savedLocalNames = Obj.magic tempStringMap1 in let map = Obj.magic (Obj.obj (HxAnon.get scope "localNameCounts")) in let tempStringMap2 = Obj.magic (Obj.obj (HxAnon.get ((Obj.magic self : t).api) "copyIntMap") (Obj.magic map)) in let savedLocalNameCounts = Obj.magic tempStringMap2 in let candidates = Obj.magic (HxMap.create_string ()) in let _g = ref 0 in (
  ignore (while !_g < HxArray.length stmts do ignore (let stmt = Obj.magic (HxArray.get (Obj.magic stmts) (!_g)) in (
  ...
  ignore (let __assign_211 = Obj.magic savedLocalTypes in (
    HxAnon.set scope "localTypes" (Obj.repr __assign_211);
    __assign_211
  ));
  ignore (let __assign_212 = Obj.magic savedLocalNames in (
    HxAnon.set scope "localNames" (Obj.repr __assign_212);
    __assign_212
  ));
  let __assign_213 = Obj.magic savedLocalNameCounts in (
...
let closureVectorTypeForLambdaArg = fun local body scope api2 -> try let __fallback_result_299 = (
...
let rec qualifiedEnumCarrierCppTypeImpl = fun expr scope api2 -> let tempResult = ref (HxString.hx_null_string : string) in (
  ignore (match expr with
    ...
    | HxExpr.EMacroExpr (_p0, _p1) -> let _g = Obj.magic _p0 in (
      ignore _p1;
      let inner = Obj.magic _g in let __assign_311 = (qualifiedEnumCarrierCppTypeImpl (Obj.magic inner) scope api2 : string) in (
    ...
    | HxExpr.EUntyped _p0 -> let _g = Obj.magic _p0 in let inner = Obj.magic _g in let __assign_313 = (qualifiedEnumCarrierCppTypeImpl (Obj.magic inner) scope api2 : string) in (
      tempResult := __assign_313;
      __assign_313
    )
    | _ -> let __assign_302 = ("" : string) in (
...
let qualifiedEnumCarrierCppType = fun expr scope api2 -> try let __fallback_result_301 = (
