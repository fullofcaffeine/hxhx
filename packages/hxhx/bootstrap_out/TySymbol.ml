...
let create = fun name2 ty2 -> let self = ({ __hx_type = HxType.class_ "TySymbol"; name = HxString.hx_null_string; ty = Obj.magic (HxRuntime.hx_null) } : t) in (
  ignore (ignore ((
...
let __empty = fun () -> ({ __hx_type = HxType.class_ "TySymbol"; name = HxString.hx_null_string; ty = Obj.magic (HxRuntime.hx_null) } : t)
