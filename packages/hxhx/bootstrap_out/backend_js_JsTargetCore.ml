...
let shouldEmitNeutralStaticFunctionBody = fun fullName fnName -> try let __fallback_result_70 = (
...
let resolveMainRef = fun main bySimpleName byFullName -> try let __fallback_result_72 = (
