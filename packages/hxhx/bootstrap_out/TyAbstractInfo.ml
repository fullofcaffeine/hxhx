...
let create = fun identity shortName modulePath fields staticMethods instanceMethods staticMethodLists instanceMethodLists declarations underlyingType2 typeParameters2 -> let self = ({ __hx_type = HxType.class_ "TyAbstractInfo"; identity = Obj.magic (HxRuntime.hx_null); shortName = ""; modulePath = ""; fields = Obj.magic (HxRuntime.hx_null); staticMethods = Obj.magic (HxRuntime.hx_null); instanceMethods = Obj.magic (HxRuntime.hx_null); staticMethodLists = Obj.magic (HxRuntime.hx_null); instanceMethodLists = Obj.magic (HxRuntime.hx_null); declarations = Obj.magic (HxRuntime.hx_null); getIdentity = (fun o () -> Obj.magic (TyNominalInfo.getIdentity__impl (Obj.magic o) (Obj.magic ()))); getFullName = (fun o () -> Obj.magic (TyNominalInfo.getFullName__impl (Obj.magic o) (Obj.magic ()))); getShortName = (fun o () -> Obj.magic (TyNominalInfo.getShortName__impl (Obj.magic o) (Obj.magic ()))); getModulePath = (fun o () -> Obj.magic (TyNominalInfo.getModulePath__impl (Obj.magic o) (Obj.magic ()))); getDeclarations = (fun o () -> Obj.magic (TyNominalInfo.getDeclarations__impl (Obj.magic o) (Obj.magic ()))); declarationForSignature = (fun o a0 -> Obj.magic (TyNominalInfo.declarationForSignature__impl (Obj.magic o) (Obj.magic a0))); declarationForSource = (fun o a0 -> Obj.magic (TyNominalInfo.declarationForSource__impl (Obj.magic o) (Obj.magic a0))); hasField = (fun o a0 -> Obj.magic (TyNominalInfo.hasField__impl (Obj.magic o) (Obj.magic a0))); fieldType = (fun o a0 -> Obj.magic (TyNominalInfo.fieldType__impl (Obj.magic o) (Obj.magic a0))); staticMethod = (fun o a0 -> Obj.magic (TyNominalInfo.staticMethod__impl (Obj.magic o) (Obj.magic a0))); instanceMethod = (fun o a0 -> Obj.magic (TyNominalInfo.instanceMethod__impl (Obj.magic o) (Obj.magic a0))); staticMethodCandidates = (fun o a0 -> Obj.magic (TyNominalInfo.staticMethodCandidates__impl (Obj.magic o) (Obj.magic a0))); instanceMethodCandidates = (fun o a0 -> Obj.magic (TyNominalInfo.instanceMethodCandidates__impl (Obj.magic o) (Obj.magic a0))); underlyingType = Obj.magic (HxRuntime.hx_null); typeParameters = Obj.magic (HxRuntime.hx_null); unaryOperators = Obj.magic (HxRuntime.hx_null); getUnderlyingType = (fun o () -> Obj.magic (getUnderlyingType__impl (Obj.magic o) (Obj.magic ()))); getTypeParameters = (fun o () -> Obj.magic (getTypeParameters__impl (Obj.magic o) (Obj.magic ()))); addUnaryOperator = (fun o a0 -> Obj.magic (addUnaryOperator__impl (Obj.magic o) (Obj.magic a0))); getUnaryOperators = (fun o a0 a1 -> Obj.magic (getUnaryOperators__impl (Obj.magic o) (Obj.magic a0) (Obj.magic a1))); getAllUnaryOperators = (fun o () -> Obj.magic (getAllUnaryOperators__impl (Obj.magic o) (Obj.magic ()))) } : t) in (
  ignore (ignore ((
    ignore (TyNominalInfo.__ctor (Obj.magic self) identity shortName modulePath fields staticMethods instanceMethods staticMethodLists instanceMethodLists declarations);
    ignore (let __assign_1 = Obj.magic underlyingType2 in (
      (Obj.magic self : t).underlyingType <- __assign_1;
