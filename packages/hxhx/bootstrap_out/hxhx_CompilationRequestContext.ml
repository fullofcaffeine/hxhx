          ...
          let tempString3 = ref (HxString.hx_null_string : string) in (
            ...
            let dependencyComparison = Obj.magic ((Obj.magic dependencyReport : Hxhx_CompilationServerDependencyReport.t).comparison) in let tempArray = ref (Obj.magic (HxRuntime.hx_null) : string HxArray.t) in (
              ignore (if dependencyComparison == Obj.magic (HxRuntime.hx_null) then let __assign_110 = Obj.magic (let __arr_111 = HxArray.create () in __arr_111) in (
                ...
                __assign_110
              ) else let __assign_112 = Obj.magic (CompilerDependencyComparison.getSourceOriginChanges (Obj.magic dependencyComparison) ()) in (
                tempArray := __assign_112;
                __assign_112
              ));
              let sourceOriginChanges = Obj.magic (!tempArray) in let tempArray1 = ref (Obj.magic (HxRuntime.hx_null) : string HxArray.t) in (
                ignore (if dependencyComparison == Obj.magic (HxRuntime.hx_null) then let __assign_113 = Obj.magic (let __arr_114 = HxArray.create () in __arr_114) in (
                  ...
                  __assign_113
                ) else let __assign_115 = Obj.magic (CompilerDependencyComparison.getConditionalCompilationChanges (Obj.magic dependencyComparison) ()) in (
                  tempArray1 := __assign_115;
                  __assign_115
                ));
                let conditionalCompilationChanges = Obj.magic (!tempArray1) in let tempArray2 = ref (Obj.magic (HxRuntime.hx_null) : string HxArray.t) in (
                  ignore (if dependencyComparison == Obj.magic (HxRuntime.hx_null) then let __assign_116 = Obj.magic (let __arr_117 = HxArray.create () in __arr_117) in (
                    ...
                    __assign_116
                  ) else let __assign_118 = Obj.magic (CompilerDependencyComparison.getGeneratedDeclarationChanges (Obj.magic dependencyComparison) ()) in (
                    tempArray2 := __assign_118;
                    __assign_118
                  ));
                  let generatedDeclarationChanges = Obj.magic (!tempArray2) in let tempArray3 = ref (Obj.magic (HxRuntime.hx_null) : string HxArray.t) in (
                    ignore (if dependencyComparison == Obj.magic (HxRuntime.hx_null) then let __assign_119 = Obj.magic (let __arr_120 = HxArray.create () in __arr_120) in (
                      ...
                      __assign_119
                    ) else let __assign_121 = Obj.magic (CompilerDependencyComparison.getPublicInterfaceChanges (Obj.magic dependencyComparison) ()) in (
                      tempArray3 := __assign_121;
                      __assign_121
                    ));
                    let publicChanges = Obj.magic (!tempArray3) in let tempArray4 = ref (Obj.magic (HxRuntime.hx_null) : string HxArray.t) in (
                      ignore (if dependencyComparison == Obj.magic (HxRuntime.hx_null) then let __assign_122 = Obj.magic (let __arr_123 = HxArray.create () in __arr_123) in (
                        ...
                        __assign_122
                      ) else let __assign_124 = Obj.magic (CompilerDependencyComparison.getImplementationChanges (Obj.magic dependencyComparison) ()) in (
                        tempArray4 := __assign_124;
                        __assign_124
                      ));
                      let implementationChanges = Obj.magic (!tempArray4) in let tempArray5 = ref (Obj.magic (HxRuntime.hx_null) : CompilerDependencyInvalidation.t HxArray.t) in (
                        ignore (if dependencyComparison == Obj.magic (HxRuntime.hx_null) then let __assign_125 = Obj.magic (let __arr_126 = HxArray.create () in __arr_126) in (
                          ...
                          __assign_125
                        ) else let __assign_127 = Obj.magic (CompilerDependencyComparison.getInvalidations (Obj.magic dependencyComparison) ()) in (
                          tempArray5 := __assign_127;
                          __assign_127
                        ));
                        let invalidations = Obj.magic (!tempArray5) in (
                          ...
                          let _g = ref 0 in let _g1 = HxArray.length invalidations in (
                            ignore (while !_g < _g1 do ignore (let index = let __old_128 = !_g in let __new_129 = HxInt.add __old_128 1 in (
                              ignore (_g := __new_129);
                              __old_128
                            ...
                            let missReasons = Obj.magic (CompilerSourceProviderReport.sortedMissReasons (Obj.magic sourceReport) ()) in (
                              ...
                              let _g = ref 0 in let _g1 = HxArray.length missReasons in (
                                ignore (while !_g < _g1 do ignore (let index = let __old_130 = !_g in let __new_131 = HxInt.add __old_130 1 in (
                                  ignore (_g := __new_131);
                                  __old_130
                                ...
                                let tempString4 = ref (HxString.hx_null_string : string) in (
                                  ignore (if isCancelled (Obj.magic self) () then let __assign_132 = "1" in (
                                    tempString4 := __assign_132;
                                    __assign_132
                                  ...
                                  let tempString5 = ref (HxString.hx_null_string : string) in (
                                    ignore (if (Obj.magic self : t).outputTransaction == Obj.magic (HxRuntime.hx_null) then let __assign_134 = ("not_started" : string) in (
                                      tempString5 := __assign_134;
                                      __assign_134
                                    ) else let __assign_135 = (Hxhx_CompilationRequestOutputTransaction.status (Obj.magic ((Obj.magic self : t).outputTransaction)) () : string) in (
                                      tempString5 := __assign_135;
                                      __assign_135
                                    ));
                                    ...
                                    let tempString6 = ref (HxString.hx_null_string : string) in (
                                      ignore (if (Obj.magic self : t).cleanupSucceeded then let __assign_136 = "ok" in (
                                        tempString6 := __assign_136;
                                        __assign_136
                                      ) else let __assign_137 = "failed" in (
                                        tempString6 := __assign_137;
                                        __assign_137
                                      ));
