...
let getCanonicalIdentity = fun self () -> (HxString.toStdString (TyLocalId.getCanonicalKey (Obj.magic ((Obj.magic self : t).identity)) ()) ^ ":type:") ^ HxString.toStdString (TyType.getSemanticKey (Obj.magic ((Obj.magic self : t).hx_type)) ())