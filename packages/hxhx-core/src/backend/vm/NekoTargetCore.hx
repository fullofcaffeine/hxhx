...
class NekoTargetCore {
	...
	static function splitChunkHeader(symbolsLoadName:String, classMeta:Array<NekoRuntimeClassMeta>):Array<String> {
		...
		out.push("");
		renderRuntimeHelpers(out, classMeta, SPLIT_SYMBOL_TABLE);
		return out;
	}
	...
	static function renderRuntimeHelpers(out:Array<String>, classMeta:Array<NekoRuntimeClassMeta>, ?symbolTable:String):Void {
		NekoRuntimeSupport.render(out, classMeta, symbolTable);
	}
