...
class ReflaxeOcamlInspection {
	...
	static inline final FUNCTION_PLAN_PIPELINE_REVISION = "ocaml-function-plans-v100";
	static inline final NESTED_FUNCTION_PIPELINE_REVISION = "ocaml-nested-function-plans-v21";
