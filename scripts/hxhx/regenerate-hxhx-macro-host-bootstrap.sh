...
ENTRYPOINTS="hxhxmacros.ExternalMacros.external();hxhxmacros.BuildFieldMacros.addGeneratedField();hxhxmacros.ReturnFieldMacros.addGeneratedFieldReturn();hxhxmacros.ReturnFieldMacros.replaceGeneratedFieldReturn();hxhxmacros.FieldPrinterMacros.addArgFunctionAndVar();hxhxmacros.ExprMacroShim.hello();Macro.init()"
