...
echo "CPP_ENUM_CARRIER_ORACLE_SEED:PASS zero=$ZERO_COUNT payload=$PAYLOAD_COUNT enumEq=$EQ_COUNT switch=$SWITCH_COUNT typeFactory=$TYPE_COUNT reflection=$REFLECT_COUNT dynamic=$DYNAMIC_COUNT serializer=$SERIALIZER_COUNT report=$REPORT"
