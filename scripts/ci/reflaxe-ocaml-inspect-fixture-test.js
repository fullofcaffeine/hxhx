...
try {
	...
	assert.strictEqual(report.schemaVersion, 27)
	...
	assert.strictEqual(report.lowering.unsafeOperationCompleteness, 'exact-null-int-null-bool-inline-dynamic-and-enum-to-dynamic-local-slices')
