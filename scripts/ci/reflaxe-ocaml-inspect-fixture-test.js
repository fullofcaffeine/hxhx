...
try {
	...
	assert.strictEqual(report.schemaVersion, 13)
	...
	assert.strictEqual(report.lowering.scope, 'typed-place-call-and-function-loop-throw-control-families')
	...
	assert.strictEqual(report.representation.scope, 'exact-int-bool-nullable-string-field-defaults-direct-simple-assignment-array-int-locals-monomorphic-class-v12')
