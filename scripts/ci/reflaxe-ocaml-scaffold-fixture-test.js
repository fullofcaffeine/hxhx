...
try {
	...
	assert.strictEqual(appInspection.representation.scope, 'exact-int-bool-nullable-string-field-defaults-direct-simple-assignment-array-int-locals-monomorphic-class-v11')
