...
try {
	...
	assert.strictEqual(appInspection.schemaVersion, 9)
	...
	assert.strictEqual(appInspection.representation.scope, 'exact-int-bool-nullable-field-defaults-direct-simple-assignment-array-int-locals-v9')
