...
function main() {
  ...
  requireIncludes(compilationServerGuide, 'Supported `reflaxe.ocaml` application workflow', compilationServerGuidePath)
  requireIncludes(compilationServerGuide, 'haxelib run reflaxe.ocaml build --connect 6000', compilationServerGuidePath)
  requireIncludes(compilationServerGuide, 'Supported `hxhx` development workflow', compilationServerGuidePath)
  requireIncludes(compilationServerGuide, 'HAXE_CONNECT=6000', compilationServerGuidePath)
