...
function proveExternalInstall(zipPath, reflaxeRoot) {
	...
	if (scaffoldInspectionReport.schemaVersion !== 13
		...
		|| scaffoldInspectionReport.representation?.scope !== 'exact-int-bool-nullable-string-field-defaults-direct-simple-assignment-array-int-locals-monomorphic-class-v12'
